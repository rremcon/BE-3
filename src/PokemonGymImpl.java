...
public class PokemonGymImpl implements PokemonGym {
    ...
    public void performAttackPlayer(Pokemon pokemon, Pokemon gymPokemon, String attack){
        ...
        switch (pokemon.getType()) {
            case "fire" -> {
                fire = new FirePokemon(gymPokemon.getType(), gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(), gymPokemon.getSound());
            ...
            case "water" -> {
                water = new WaterPokemon(gymPokemon.getType(), gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(), gymPokemon.getSound());
                switch (choosenAttack) {
            ...
            case "grass" -> {
                grass = new GrassPokemon(gymPokemon.getType(), gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(), gymPokemon.getSound());
                switch (choosenAttack) {
            ...
            default -> {
                electric = new ElectricPokemon(gymPokemon.getType(), gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(), gymPokemon.getSound());
                switch (choosenAttack) {
